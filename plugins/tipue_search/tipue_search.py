...
class Tipue_Search_JSON_Generator(object):
    ...
    def create_json_node(self, page):
        ...
        # modification by Eric Kim: when using tipuesearch for articles generated using ipynb plugin, script and style
        # tags are pasted into tipuesearch_content.js, and causes js script and css styles for jupyter notebook is
        # shown in search results. This is not desirable, so I excluded script and style tags.
        for s in soup_text(['script', 'style']):
            s.decompose()
